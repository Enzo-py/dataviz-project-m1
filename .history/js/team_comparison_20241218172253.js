...
document.addEventListener("DOMContentLoaded", function() {
   // Get parameters from link 
    ...
    function aggregateTeamData(teamDataArray) {
        ...
        const sumFields = [
            "Wins", "losses", "draws",
            "Wins home", "draws_home", "losses_home",
            "Wins away", "draws_away", "losses_away",
            "Matches played home", "matches played away",
            "Goals scored", "goals_conceded",
            "Goals scored (home)", "goals_conceded_home",
            "Goals scored (away)", "goals_conceded_away",
            "Clean sheets home", "Clean sheets away",
            "Cards_total_home", "cards_total_away",
            "Shots", "shots_home", "shots away",
            "Shots on target", "shots_on_target_home", "shots_on_target_away",
            "Shots_off target", "shots_off_target_home", "shots_off_target_away"
        ];
