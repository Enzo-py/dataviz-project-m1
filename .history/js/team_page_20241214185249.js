    ...
    function updateStats() {
        ...
        if (team1) {
            ...
            if (season === "All Seasons") {
                ...
                data1 = ctx.teams["2021-2022"].find(team => team.common_name === team1);
                data2 = ctx.teams["2023-2024"].find(team => team.common_name === team1);
            ...
            teamRatioElement.textContent = "W/L/D: " + ratio
        } else {
