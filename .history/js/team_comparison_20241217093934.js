   ...
   // Get parameters from link 
    ...
    function updateStats() {
        ...
        if (team1) {
            ...
            if (season === "All Seasons") {
                ...
                if (team1DataArray.length === 0) {
                    ...
                    team&ankElement.textContent = "N/A";
            ...
            const league1 = countryToLeague[country] || "Unknown League";
            team1LeagueElement.textContent = league;
            // Update Rank
            if (season === "All Seasons") {
        ...
        if (team2) {
            ...
            // Update League
            const country2 = data2 && data1.length > 0 ? data1.country.toLowerCase() : data1 ? data1.country.toLowerCase() : "";
            const league1 = countryToLeague[country] || "Unknown League";
            team1LeagueElement.textContent = league;
            // Update Rank
            if (season === "All Seasons") {
