...
document.addEventListener("DOMContentLoaded", function() {
   // Get parameters from link 
    ...
    // Add event listeners to team logos
    ...
    function updateStats() {
        ...
        if (team1 && team2 && team1 !== team2) {
            ...
            const matchesTitleElement = document.querySelector('.matches h2');
            matchesTitleElement.textContent = "Please select two different teams to compare.";
    ...
    function aggregateTeamData(teamDataArray) {
        ...
        const sumFields = [
            ...
            "clean_sheets", "cards_total", "fouls", "corners_per_match"
        ];
