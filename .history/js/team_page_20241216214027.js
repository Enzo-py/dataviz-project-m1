...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelectorAll("#toggle-league-average").forEach(button => {
        button.addEventListener("click", function() {
            ...
            viewPlayersButton.addEventListener("click", function() {
                const team1 = document.getElementById("team1").value;
                if (team1) {
                    window.location.href = `players.html?club=${encodeURIComponent(team1)}`;
                } else {
    ...
    function updateStats() {
        ...
        if (team1) {
            ...
            const viewPlayersLink = document.getElementById("view-players");
            if (viewPlayersLink) {
                console.log("adding player")
                viewPlayersLink.href = `players.html?club=${encodeURIComponent(team1)}`;
            }
            // Update info            
            if (logoURL) {
