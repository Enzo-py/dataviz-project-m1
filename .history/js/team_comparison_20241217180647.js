   ...
   // Get parameters from link 
    ...
    function updateStats() {
        ...
        if (team1) {
            ...
            // No data for team1
            document.getElementById("team1-stats").innerHTML = `<p>No data available for ${team1}.</p>`;
        } else {
        ...
        if (team2) {
            ...
            // No data for team2
            document.getElementById("team2-stats").innerHTML = `<p>No data available for ${team2}.</p>`;
        } else {
