...
function showMatchDetails(match) {
    ...
    // Update cards
    updateCards('home-cards-first', match.home_team_first_half_yellow_cards, match.home_team_first_half_red_cards);
    updateCards('home-cards-second', match.home_team_second_half_yellow_cards, match.home_team_second_half_red_cards);
    updateCards('away-cards-first', match.away_team_first_half_yellow_cards, match.away_team_first_half_red_cards);
    updateCards('away-cards-second', match.away_team_second_half_yellow_cards, match.away_team_second_half_red_cards);
