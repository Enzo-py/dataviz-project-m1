...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const playerPage = "player.html?club"= teamParam;

    // Define a function to redirect to the player page
    ...
    // // Update both links
    // d3.selectAll("a.view-team-players").attr("location.href", player_page);
