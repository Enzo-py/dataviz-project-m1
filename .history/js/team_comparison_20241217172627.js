...
document.addEventListener("DOMContentLoaded", function() {
   // Get parameters from link 
    ...
    function updateStats() {
        ...
        if (team1) {
            let data1;
            document.getElementById("team-stats").innerHTML = `<h2>${team1} Stats (${season})</h2><p>Stats for ${team1} in ${season} will be displayed here.</p>`;
            ...
            if (season === "All Seasons") {
                ...
                if (team1DataArray.length === 0) {
                    team1Info.textContent = "Second Division";
                    return;
                }
        ...
        if (team2) {
            ...
            if (season === "All Seasons") {
                ...
                if (team2DataArray.length === 0) {
                    team2Info.textContent = "Second Division";
                    return;
                }
        ...
        if (team1 && team2) {
            ...
            document.getElementById("team-stats").innerHTML = `<p>Please select a team.</p>`;
        }
        updateMatchesList();
    }
    ...
    function compareTeams(team1, team2, season) {
        ...
        document.getElementById("team-stats").innerHTML = `<h2>${team1} Stats (${season})</h2>` + comparisonHtml1;
    }
