...
document.getElementById("a.view-team-players").addEventListener("onClick", function() {
    const team1 = document.getElementById("team1").value;
    if (team1) {
        location.href = `player.html?team=${encodeURIComponent(team1)}`;
    } else {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // // Update both links
    // d3.selectAll("a.view-players").attr("href", player_page);
