            ...
            row.addEventListener("click", () => {
                ...
                `
                    ...
                    if (page_tutorial_ended) { // define in the page
                        message += `
                            <p>&nbsp;</p>
                            <p style="display: flex; gap: 4px; align-items: center;">Click on the <span class="material-symbols-outlined">compare_arrows</span> icon to continue the tutorial.</p>
                        `
                    }
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateStats() {
        ...
        if (team1) {
            ...
            leagueLogo.src = `data/img/Leagues/${leagues}.png`; // Assuming league logos are stored in this path
            ...
            const ratio = `
                <span style="color: #28a745;">${wins}</span> / 
                <span style="color: #dc3545;">${losses}</span> / 
                <span style="color: #6c757d;">${draws}</span>
            `;
            teamRatioElement.innerHTML = ratio;
