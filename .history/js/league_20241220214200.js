...
function updateTopPlayers() {
    ...
    // Top attackers
    const topAttackers = players.filter(player => player.rank_in_league_top_attackers <= 3 && player.rank_in_league_top_attackers !== 0);
    ...
    // Top midfielders
    const topMidfielders = players.filter(player => player.rank_in_league_top_midfielders <= 3);
