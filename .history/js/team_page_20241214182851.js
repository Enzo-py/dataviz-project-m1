...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateStats() {
        ...
        if (team1) {
            ...
            // Update Team Stats
            const wins = data1 && data1.length > 0 ? data1.data.wins : data1 ? data1.rank : "Error";
            const losses = data1 && data1.length > 0 ? data1.data.losses : data1 ? data1.rank : " Error";
            const draws = data1 && data1.length > 0 ? data1.data.draws : data1 ? data1.rank : "Error";
        } else {
