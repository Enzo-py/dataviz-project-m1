...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateStats() {
        ...
        if (team1) {
            ...
            createGoalsDonutChart(data1);  // Add this line
...
function createGoalsDonutChart(data) {
    ...
    const width = 280;  // Increased width to accommodate legend
    const height = 20;
    ...
    const legend = svg.append("g")
        .attr("transform", `translate(${radius - 100},${radius - 40})`);  // Position at bottom right
