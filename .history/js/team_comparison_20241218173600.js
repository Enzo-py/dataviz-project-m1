   ...
   // Get parameters from link 
    ...
    function compareTeams(team1, team2, data1, data2, season) {
        ...
        const comparisonMetrics = [
            "Wins", "Losses", "Draws", "Goals Scored", "Goals Conceded", "Clean Sheets", "Average Possession"
        ];
    ...
    function getTeamStats(team, data) {
        ...
        return {
            ...
            "Possession Percentage": data.possession_percentage,
            Tackles: data.tackles,
            Saves: data.saves,
            "Penalties Scored": data.penalties_scored,
            "Penalties Missed": data.penalties_missed
        };
    }
});
