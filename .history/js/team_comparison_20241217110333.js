...
function updateMatchesList() {
    ...
    const team2 = document.getElementById("team1").value;
            ...
            if (ctx.matches[s]) {
                allMatches = allMatches.concat(
                    ctx.matches[s].filter(match =>
                        (match.home_team_name === team1 || match.away_team_name === team1) &&(match.home_team_name === team2 || match.away_team_name === team2)
                    )
                );
            }
        });
   ...
   // Get parameters from link 
    ...
    function updateStats() {
        ...
        if (team1) {
            ...
            const team1Info = document.getElementById("team1-league");
            const logoURL1 = ctx.logos[team1];
            const team1RankElement= document.getElementById("team1-rank");
            const team1RatioElement = document.getElementById("team1-ratio");
        ...
        if (team2) {
            ...
            const team2RankElement= document.getElementById("team2-rank");
            const team2RatioElement = document.getElementById("team2-ratio");
