...
function showMatchDetails(match) {
    ...
    let htScores = ['0', '0'];
    if (match.ht_score && match.ht_score.includes('-')) {
        htScores = match.ht_score.split('-');
    }
    matchDetails.querySelector('.home-ht').textContent = htScores[0];
    matchDetails.querySelector('.away-ht').textContent = htScores[1];
