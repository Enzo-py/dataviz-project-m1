...
function updateTopPlayers() {
    ...
    // Top attackers
    const topAttackers = players.filter(player => player.rank_in_league_top_attackers <= 5 && player.rank_in_league_top_attackers >= 1);
    ...
    // Top midfielders
    const topMidfielders = players.filter(player => player.rank_in_league_top_midfielders <= <= 5 && player.rank_in_league_top_midfielders >= 1);
    ...
    // Top defenders
    const topDefenders = players.filter(player => player.rank_in_league_top_defenders <= <= 5 && player.rank_in_league_top_defenders >= 1);
