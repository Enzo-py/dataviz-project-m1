...
const cols_categories = {
    "PLAYER_INFORMATION": ['full_name', 'age', 'birthday', 'birthday_GMT', 'position', 'Current Club', 'nationality', 'additional_info', 'games_subbed_out', 'games_subbed_in', 'games_started', 'market_value', 'market_value_percentile', 'annual_salary_eur', 'annual_salary_eur_percentile', 'shirt_number', 'annual_salary_gbp', 'annual_salary_usd'],
    "COMPETITION": ['league'],
    "SEASON": ['season', 'sm_matches_recorded_total_overall'],
    "POSITION": ['position'],
    "TEAM_INFORMATION": ['Current Club'],
    ...
    "GOALKEEPER": ['is_goalkeeper', 'inside_box_saves_total_overall', 'is_shooter', 'saves_per_game_overall', 'shots_faced_per_game_overall', 'saves_total_overall', 'save_percentage_percentile_overall', 'saves_per_90_overall', 'saves_per90_percentile_overall', 'shots_faced_total_overall', 'shots_per_goal_conceded_overall', 'sm_goals_conceded_total_overall', 'shots_faced_per_90_overall', 'shots_faced_per90_percentile_overall', 'xg_faced_per_90_overall', 'xg_faced_per90_percentile_overall', 'xg_faced_per_game_overall', 'xg_faced_total_overall', 'save_percentage_overall', 'inside_box_saves_total_overall', 'pen_save_percentage_overall', 'pens_saved_total_overall', 'punches_total_overall', 'punches_per_game_overall', 'punches_per_90_overall', 'min_per_conceded_percentile_overall', 'punches_per90_percentile_overall', 'clean_sheets_percentage_percentile_overall'],
...
function populate_players() {
    ...
    Object.keys(ctx.data["players_agg"]).forEach(player_id => {
        ...
        current_club = player[years[years.length - 1]]["Current Club"]
...
function create_player_card(player_id) {
    ...
    player_club = player[Object.keys(player)[0]]["Current Club"]
